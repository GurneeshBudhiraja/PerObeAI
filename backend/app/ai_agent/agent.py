...
from .agent_tools import retrieve_upperwear, retrieve_lowerwear, format_return_data, get_temperature_by_city
...
def agent(user_id:str, user_prompt:str, city:str, preferred_fashion_style:str|None=None)->list:
  try:
    ...
    tools = [get_temperature_by_city ,retrieve_upperwear, retrieve_lowerwear, format_return_data]
