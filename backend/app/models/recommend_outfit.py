...
class RecommendOutfit(BaseModel):
  description: str = Field(None, title="The description of the outfit", description="""
      ...
      If the user has no sort of visual impairements you will explain the image in a normal like pointing to a specific thing that will help the user know what has been referred to. 
